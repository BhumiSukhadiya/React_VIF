...
const CompanyCell = ({rowIndex, data, onClickFun, ...props}) => {
    ...
    if (Index !== undefined) {
        return (
            <Cell {...props}>
                <div><a onClick={() => onClickFun(data['data'][Index])}
                        style={{color: '#d06202'}}>{data['data'][Index].name}</a></div>
            </Cell>)
    }
    ...
    render() {
        ...
        return (
            ...
            <div className="log-table">
                {this.state.selectedParentCompany !== null &&
                <ParentCompanyModal openDialog={this.state.showParentCompanyModal}
                                    onClose={this.closeParentCompanyModal}
                                    selectedParentCompany={this.state.selectedParentCompany}/>}
                <button onClick={() => this.openParentCompanyModal('')}
                        style={{
                            color: 'white',
                            backgroundColor: '#e96e02',
                            borderColor: '#df6902',
                            float: 'right',
                            padding: 10
                        }}>+
                ...
                <center>
                    {(this.state.sortedDataList !== undefined && this.state.colSortDirs !== undefined) ? this.state.sortedDataList.getSize() > 0 ? (
                                <Table
                                    maxHeight={550}
                                    width={1200}
                                    ...
                                    <Column
                                        ...
                                        cell={<CompanyCell data={this.state.sortedDataList}
                                                           onClickFun={this.openParentCompanyModal}/>}
                                        width={150}
                                    />
